...
public class HashmapSerializationFiftTests {
    ...
    public void testHashmapSerialization1() {
        ...
        String actualResult1 = UtilsStr.sb(result, "hashmap-serialization-1-cellPrint: ", "end").replaceAll("\\r", "").trim();
        String actualResult2 = UtilsStr.sb(result, "hashmap-serialization-1-cellHash: ", "\n").trim();
        String actualResult3 = UtilsStr.sb(result, "hashmap-serialization-1-cellBocWithCrc: ", "\n").trim();
