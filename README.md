...
- [Address](https://github.com/neodix42/ton-sdk-test-cases/blob/main/address.json) [(ton4j)](https://github.com/neodix42/ton4j/blob/main/address/src/test/java/org/ton/java/address/TestTonSdkTestCasesAddress.java)
    ...
    5. address-5 - Test conversion of raw address with a wrong (two) workchain.
    6. address-6 - Test conversion of master raw address.
    7. address-7 - Test conversion of elector raw address.
    8. address-8 - Test conversion of url-safe base64 encoded address.
    9. address-9 - Test conversion of non-url-safe base64 encoded non-bounceable address.
    10. address-10 - Test conversion of url-safe base64 encoded address with a wrong checksum.
    11. address-11 - Test conversion of raw address with too short hash size.
    12. address-12 - Test conversion of raw address with too long hash size.
